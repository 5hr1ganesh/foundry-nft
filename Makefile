...
ifeq ($(findstring --network virtualETH,$(ARGS)),--network virtualETH)
	NETWORK_ARGS := --rpc-url $(VIRTUAL_ETH_RPC_URL) --private-key $(PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
endif
